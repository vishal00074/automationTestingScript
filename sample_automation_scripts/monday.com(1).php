...
class PortalScriptCDP
{
                ...
                foreach ($receipts as $i => $receipt) {
                    ...
                    if (count($tags) >= 5) {
                        ...
                        if (strpos($receiptUrl, 'http') === false) {
                            try{
                                $receiptUrl = $this->exts->executeSafeScript("return arguments[0].href;", [$this->exts->getElement('td button', $receipt)]);
                            } catch(\Exception $e){
                                $receiptUrl = null; 
                            ...
                            if ($receiptUrl == null || $receiptUrl == '') {
                                ...
                                if ($actions != null) {
                                    ...
                                    $this->exts->click_element($actions);
                                    sleep(5);
    ...
    private function donwloadSingleInvoice($buttonSelector, $invoiceDate, $invoiceAmount, $index)
    {
