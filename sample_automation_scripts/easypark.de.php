<?php // handle empty invoiceName condition added code to extract invoiceAmount and date
...
class PortalScriptCDP
{
    ...
    // Server-Portal-ID: 9754 - Last modified: 12.03.2025 13:56:10 UTC - User: 1
    ...
    function processHistoryReceipts()
    {
    ...
    function donwloadInvoices2($count, $startngDivIndex)
    {
        $recordRow = 0;
