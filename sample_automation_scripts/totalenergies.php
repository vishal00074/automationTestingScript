...
public $check_login_success_selector = 'span[class="user-profile-img user-profile-initial blue-one"], table#cardProAccountList';
...
private function processInvoices() {
    ...
    $this->exts->waitTillPresent('table#invoiceListTable tbody tr', 15);
