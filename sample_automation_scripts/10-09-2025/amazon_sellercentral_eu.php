...
class PortalScriptCDP
{
    ...
    // Server-Portal-ID: 156697 - Last modified: 22.08.2025 15:13:07 UTC - User: 1
    ...
    private function initPortal($count)
    {
        ...
        if ($this->isLoginSuccess()) {
            ...
            if ($this->exts->exists('button.full-page-account-switcher-account-details')) {
                ...
                sleep(8);
                if ($this->exts->exists('button[class*="kat-button"]:not([disabled]), [data-test="confirm-selection"]')) {
                    $this->exts->moveToElementAndClick('button[class*="kat-button"]:not([disabled]), [data-test="confirm-selection"]');
                    sleep(10);
                }
            }
    ...
    private function downloadStatements($pageCount = 1)
    {
        ...
        $this->waitForSelectors("table > tbody > tr a[href*='/settlement-summary']", 10, 3);
