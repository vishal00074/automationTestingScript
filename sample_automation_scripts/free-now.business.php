...
class PortalScriptCDP
{
    ...
    // Server-Portal-ID: 158574 - Last modified: 31.10.2024 12:23:09 UTC - User: 1
    ...
    private function initPortal($count)
    {
        ...
        if ($this->exts->getElement($this->check_login_success_selector) == null || $username_txt != '') {
            ...
            // $this->exts->waitTillPresent('.banner-animation-appear-done.banner-animation-enter-done');
            // if(strpos(strtolower($this->exts->extract('.banner-animation-appear-done.banner-animation-enter-done')), 'deine login-daten sind') !== false ||
            // 	strpos(strtolower($this->exts->extract('.banner-animation-appear-done.banner-animation-enter-done')), 'login credentials are invalid') !== false){
            // 	$this->exts->loginFailure(1);
            // }
            if ($this->exts->waitTillPresent(".banner-animation-appear-done.banner-animation-enter-done", 25)) {
