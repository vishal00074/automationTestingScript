...
class PortalScriptCDP
{
    ...
    private function initPortal($count)
    {
        ...
        if (!$isCookieLoginSuccess) {
            ...
            if ((int) @$this->login_with_google == 1) {
                ...
                $this->fillForm(0);
                sleep(10);
                if ($this->exts->exists('div[class*="onboarding_components"] div[class*="close_button--closeX"]')) {
    ...
    private function fillFormOnelogin($count = 0)
    {
        ...
        try {
            if ($this->exts->getElement('input#username') != null) {
                ...
                if ($this->exts->exists('[type="error"]')) {
    ...
    private function ProcessMultilTeams()
    {
        ...
        sleep(2);
        if ($this->exts->exists('div[class*=planSwitcherRow]')) {
            ...
            if ($team_len > 0) {
                for ($i = 0; $i < $team_len; $i++) {
                    ...
                    if ($team_sel) {
                        ...
                        if ($this->exts->exists('div[data-testid="admin-settings-link"]')) {
