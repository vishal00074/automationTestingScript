<?php // optimized
// Server-Portal-ID: 38757 - Last modified: 13.02.2025 05:59:28 UTC - User: 1
...
private function initPortal($count)
{
    ...
    if (!$isCookieLoginSuccess) {
        ...
        if ($this->checkLogin()) {
            ...
            if ($this->exts->exists('div#freeze-account')) {
                $Str = $this->exts->extract('div#freeze-account');
                $this->exts->log('Str - ' . $Str);
                //if(trim($Str))
                //$this->exts->account_not_ready();
            }
