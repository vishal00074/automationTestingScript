<?php // remvoe unused function checkConfirmPassword added configuration for recovery email and security phone number in google login code
/**
...
class PortalScriptCDP
{
    ...
    // Server-Portal-ID: 450 - Last modified: 04.09.2025 13:29:05 UTC - User: 1
    ...
    private function initPortal($count)
    {
        ...
        if ($this->exts->getElement('[data-id="PP-ProfileChooser-Chooser"] [data-id="PP-ProfileChooser-AuthAccount"]') != null) {
            ...
            $this->exts->click_element('[data-id="PP-ProfileChooser-AuthAccount"] > div:last-child');
            sleep(5);
        }
        ...
        if ($this->exts->getElement($this->check_login_success_selector) == null) {
            ...
            while ($this->exts->querySelector('button[data-id="PP-I2TUpgrade-ContinueBtn"]') != null) {
                $this->exts->click_element('button[data-id="PP-I2TUpgrade-ContinueBtn"]');
                sleep(10);
            }
            ...
            if ($this->exts->getElement('[data-id="PP-ProfileChooser-Chooser"] [data-id="PP-ProfileChooser-AuthAccount"]') != null) {
                ...
                if ($this->exts->getElement('[data-id="PP-ProfileChooser-AuthAccount"] > div:last-child') != null) {
                    $this->exts->click_element('[data-id="PP-ProfileChooser-AuthAccount"] > div:last-child');
                    sleep(15);
