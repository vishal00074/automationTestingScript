...
class PortalScriptCDP
{
    ...
    // Server-Portal-ID: 419 - Last modified: 15.04.2025 13:37:08 UTC - User: 1
    ...
    private function initPortal($count)
    {
        ...
        if ($this->exts->exists('form[action="/settings/two_factor_checkup"] button')) {
            $this->exts->moveToElementAndClick('form[action="/settings/two_factor_checkup"] button');
            sleep(10);
            $this->checkFillTwoFactor();
        }
