<?php  // tested the script download code  few inovice is not downloadin due to link not found in portal
// Server-Portal-ID: 916 - Last modified: 06.03.2025 14:09:44 UTC - User: 1
    ...
    for ($paging_count = 1; $paging_count < $maxPages; $paging_count++) {
        ...
        for ($i = 0; $i < $rows; $i++) {
            ...
            if ($download_button != null) {
                ...
                $this->exts->log('Get Current URl: '. $this->exts->getUrl());
