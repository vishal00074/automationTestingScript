...
class PortalScriptCDP
{
	...
	// Server-Portal-ID: 391 - Last modified: 27.03.2025 13:55:26 UTC - User: 1
	...
	private function doAfterLogin()
	{
		...
		if ($this->isLoggedIn()) {
			...
			if ($this->isExists('a#ShellAdmin_link[href*="admin.microsoft.com"], #appsModule a[href*="admin.microsoft.com"]')) {
