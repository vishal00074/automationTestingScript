...
class PortalScriptCDP
{
    ...
    private function initPortal($count)
    {
        ...
        if ($this->checkLogin()) {
            ...
            // click on invoice
            $this->exts->waitTillPresent('ul.t-Cards--basic#R200_SHORTCUT_CARDS_cards li:nth-child(3)', 10);
            if ($this->exts->exists('ul.t-Cards--basic#R200_SHORTCUT_CARDS_cards li:nth-child(3)')) {
                $this->exts->moveToElementAndClick('ul.t-Cards--basic#R200_SHORTCUT_CARDS_cards li:nth-child(3)');
                sleep(2);
            }
