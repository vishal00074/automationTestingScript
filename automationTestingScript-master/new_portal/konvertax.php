...
class PortalScriptCDP
{
    ...
    public $baseUrl = 'https://konvertax.de/';
    public $loginUrl = 'https://konvertax.de/login';
    public $invoicePageUrl = 'https://konvertax.de/invoice';
    ...
    public $check_login_success_selector = 'a[class="nk-menu-link"][href="/logout"]';
    ...
    private function downloadInvoices($count = 0)
    {
        ...
        foreach ($rows as $key => $row) {
            $invoiceBtn = $this->exts->getElement('a[href*="/invoice/"]', $row);
            if ($invoiceBtn != null) {
                sleep(2);
