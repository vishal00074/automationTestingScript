...
class PortalScriptCDP
{
    ...
    public $baseUrl = 'https://app.datacake.de/';
    public $loginUrl = 'https://app.datacake.de/login';
    public $invoicePageUrl = 'https://app.datacake.de/bed/administration/billing';
    ...
    public $check_login_failed_selector = 'span.text-xs';
    public $check_login_success_selector = 'a[href="/bed/administration/billing"]';
    ...
    private function initPortal($count)
    {
        ...
        if ($this->checkLogin()) {
            ...
            sleep(10);
            $this->exts->waitTillPresent('div.bg-white:nth-child(3)  button.items-center');
            if ($this->exts->exists('div.bg-white:nth-child(3)  button.items-center')) {
                $this->exts->moveToElementAndClick('div.bg-white:nth-child(3)  button.items-center');
                sleep(2);
            }
            ...
            if (stripos($error_text, strtolower('E-Mail und Passwort stimmen nicht überein')) !== false) {
    ...
    private function downloadInvoices($count = 0)
    {
        ...
        foreach ($invoices as $invoice) {
            ...
            sleep(7);
            $invoiceName = time(); // create custom name in case invoice name not found
            $invoiceDate = '';
