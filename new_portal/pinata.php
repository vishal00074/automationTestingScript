...
class PortalScriptCDP
{
    ...
    public $baseUrl = 'https://app.pinata.cloud/ipfs/files';
    public $loginUrl = 'https://app.pinata.cloud/ipfs/files';
    public $invoicePageUrl = 'https://app.pinata.cloud/settings/plans';

    public $username_selector = 'input[name="identifier"]';
    public $password_selector = 'input[name="password"]';
    public $remember_me_selector = '';
    public $submit_login_selector = 'button[data-localization-key="formButtonPrimary"]';

    public $check_login_failed_selector = 'p#error-identifier, p#error-password';
    public $check_login_success_selector = 'div.MuiAvatar-circular';
    ...
    private function initPortal($count)
    {
        ...
        if ($this->checkLogin()) {
            ...
            if ($this->exts->exists('button#managePaymentInfoButton')) {
                $this->exts->moveToElementAndClick('button#managePaymentInfoButton');
                sleep(5);
            }
            ...
            if (
                stripos($error_text, strtolower("Couldn't find your account")) !== false ||
                stripos($error_text, strtolower("Password is incorrect")) !== false
            ) {
    ...
    public function fillForm($count)
    {
        ...
        if ($this->exts->querySelector($this->username_selector) != null) {
            ...
            sleep(2);
            $this->exts->capture("1-login-email-page-filled");
