...
class PortalScriptCDP
{
    ...
    public $baseUrl = 'https://publisher.cpx-research.com/index.php?page=statistics_account_balance';
    public $loginUrl = 'https://publisher.cpx-research.com/index.php?page=statistics_account_balance';
    public $invoicePageUrl = 'https://publisher.cpx-research.com/index.php?page=statistics_account_balance';
    ...
    public $check_login_failed_selector = 'div.alert-warning';
    public $check_login_success_selector = 'div.drp-user';
    ...
    private function downloadInvoices($count = 1)
    {
        ...
        $this->exts->waitTillPresent('div.row:nth-child(3) table tbody tr');
        $this->exts->capture("4-invoices-classic");

        $invoices = [];
        $rows = $this->exts->getElements('div.row:nth-child(3) table tbody tr');
        foreach ($rows as $key => $row) {
            $invoiceLink = $this->exts->getElement('a[href*="index.php?page=payment-details"]', $row);
            if ($invoiceLink != null) {
        ...
        foreach ($invoices as $invoice) {
            ...
            sleep(4);
            $this->waitFor('div[class="row invoice-contact"]');
            
            if ($this->exts->querySelector('div[class="row invoice-contact"]') != null) {
