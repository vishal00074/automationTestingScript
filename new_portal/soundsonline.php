...
class PortalScriptCDP
{
    ...
    public $baseUrl = 'https://www.soundsonline.com/account/';
    public $loginUrl = 'https://www.soundsonline.com/account/';
    public $invoicePageUrl = 'https://www.soundsonline.com/account/orders/';

    public $username_selector = 'input[name="user_email"]';
    public $password_selector = 'input[name="user_password"]';
    public $remember_me_selector = '';
    public $submit_login_selector = 'div#login-submit';

    public $check_login_failed_selector = 'div.error.response';
    ...
    private function downloadInvoices($count = 1)
    {
        ...
        foreach ($rows as $key => $row) {
            $invoiceLink = $this->exts->getElement('td:nth-child(7) a', $row);
            if ($invoiceLink != null) {
        ...
        $pagiantionSelector = 'a[class="paginate_button next"]';
        if ($restrictPages == 0) {
