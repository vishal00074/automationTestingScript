...
class PortalScriptCDP
{
    ...
    public $baseUrl = 'https://service.re-fd.de/css/index.html#/dashboard/';
    public $loginUrl = 'https://service.re-fd.de/css/index.html#/dashboard/';
    public $invoicePageUrl = 'https://service.re-fd.de/css/index.html#/invoiceOverview/';
    ...
    public $check_login_failed_selector = 'span.kc-feedback-text';
    public $check_login_success_selector = 'button.logoutSidenavButton';
    ...
    private function initPortal($count)
    {
        ...
        sleep(12);
        if ($this->exts->querySelector('div[id="usercentrics-root"]') != null) {
