...
class PortalScriptCDP
{
    ...
    public $baseUrl = 'https://connect.shirt-king.de/';
    public $loginUrl = 'https://connect.shirt-king.de/login';
    public $invoicePageUrl = 'https://connect.shirt-king.de/invoices';
    ...
    public $check_login_failed_selector = 'div.invalid-feedback';
    ...
    private function initPortal($count)
    {
        ...
        if ($this->checkLogin()) {
            ...
            if (stripos($error_text, strtolower('Ihre Anmeldedaten sind nicht korrekt')) !== false ) {
