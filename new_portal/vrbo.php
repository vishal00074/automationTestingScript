...
public $loginUrl = 'https://www.vrbo.com/auth/ui/login';
public $invoicePageUrl = '';

public $username_selector = 'input[name="emailAddress"]';
public $password_selector = 'input[name="password"]';
public $remember_me_selector = 'input[name="rememberMe"]';
public $submit_login_selector = 'button[name="login"]:not(:disabled)';
...
function fillForm($count)
{
    ...
    try {
        if ($this->exts->querySelector($this->username_selector) != null) {
            ...
            if($this->exts->exists('input[id="callContact"]')){
                $this->exts->moveToElementAndType('input[id="callContact"]');
                sleep(10);
            }
        }
