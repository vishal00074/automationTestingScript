...
class PortalScriptCDP
{
    ...
    public $baseUrl = 'https://www.synalabs.com/clientarea.php?action=invoices';
    public $loginUrl = 'https://www.synalabs.com/clientarea.php?action=invoices';
    public $invoicePageUrl = 'https://www.synalabs.com/clientarea.php?action=invoices';
    ...
    public $check_login_success_selector = 'li a[href="/logout.php"].btn';
    ...
    private function initPortal($count)
    {
        ...
        if ($this->checkLogin()) {
            ...
            if (stripos($error_text, strtolower('Adresse de courriel ou mot de passe incorrects. Veuillez essayer à nouveau')) !== false) {
    ...
    private function downloadInvoices($count = 0)
    {
        ...
        foreach ($invoices as $invoice) {
            ...
            sleep(7);
            $this->exts->waitTillPresent('a[href*="dl.php?"]');
