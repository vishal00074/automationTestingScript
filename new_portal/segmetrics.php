...
class PortalScriptCDP
{
    ...
    public $baseUrl = 'https://app.segmetrics.io/a1gKQX/account/billing';
    public $loginUrl = 'https://app.segmetrics.io/a1gKQX/account/billing';
    public $invoicePageUrl = 'https://app.segmetrics.io/a1gKQX/account/billing';
    ...
    public $check_login_failed_selector = 'span.invalid-feedback';
    ...
    private function initPortal($count)
    {
        ...
        if ($this->checkLogin()) {
            ...
            if ($this->exts->exists('div.modal-content button')) {
                $this->exts->moveToElementAndClick('div.modal-content button');
                sleep(2);
            }
            ...
            if (stripos($error_text, strtolower('These credentials do not match our records')) !== false) {
    ...
    private function downloadInvoices($count = 1)
    {
        ...
        foreach ($invoices as $invoice) {
            ...
            if ($this->exts->querySelector('address a[href="mailto:support@segmetrics.io"]') != null) {
