...
class PortalScriptCDP
{
    ...
    public $baseUrl = 'https://partner.municall.de/finance/abrechnungen';
    public $loginUrl = 'https://partner.municall.de/finance/abrechnungen';
    public $invoicePageUrl = 'https://partner.municall.de/finance/abrechnungen';
    ...
    public $check_login_failed_selector = 'div.alert-message';
    public $check_login_success_selector = 'div.login-greeting a[href*="menulogout"]';
    ...
    private function downloadInvoices($count = 1)
    {
        ...
        foreach ($rows as $key => $row) {
            $invoiceLink = $this->exts->getElement('a[href*="download"]', $row);
            if ($invoiceLink != null) {
        ...
        $pagiantionSelector = 'ul.pagination  li  a[aria-label="Zur Seite weiter wechseln"]';
        if ($restrictPages == 0) {
