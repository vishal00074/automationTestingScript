...
class PortalScriptCDP
{
    ...
    public $baseUrl = 'https://www.allianztravel-agentmax.de/#/Reports';
    public $loginUrl = 'https://www.allianztravel-agentmax.de/#/login';
    public $invoicePageUrl = 'https://www.allianztravel-agentmax.de/#/Reports';
    ...
    private function initPortal($count)
    {
        ...
        if ($this->checkLogin()) {
            ...
            if (stripos($error_text, strtolower('Ihre Anmeldedaten sind ungültig. Bitte versuchen Sie es erneut.')) !== false) {
    ...
    private function downloadInvoices($count = 1)
    {
        ...
        foreach ($rows as $key => $row) {
            $invoiceBtn = $this->exts->getElement('td:nth-child(2) img:nth-child(1)', $row);
            if ($invoiceBtn != null) {
                $invoiceUrl = '';
                $invoiceName = '';
