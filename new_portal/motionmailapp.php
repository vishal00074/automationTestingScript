...
class PortalScriptCDP
{
    ...
    public $baseUrl = 'https://motionmailapp.com/dashboard/account/plan-and-billing';
    public $loginUrl = 'https://motionmailapp.com/dashboard/account/plan-and-billing';
    public $invoicePageUrl = 'https://motionmailapp.com/dashboard/account/plan-and-billing';
    ...
    public $check_login_failed_selector = 'div.input-group__error';
    public $check_login_success_selector = 'button[aria-controls="myAccountMenu"]';
    ...
    private function downloadInvoices($count = 1)
    {
        ...
        foreach ($invoices as $invoice) {
            ...
            // $$this->exts->direct_download($invoice['invoiceUrl'], 'pdf', $invoiceFileName);
        ...
        $pagiantionSelector = 'nav li.dashboard__table-nav-item:nth-child(3) button';
        if ($restrictPages == 0) {
