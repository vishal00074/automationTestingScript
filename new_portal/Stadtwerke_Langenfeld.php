...
class PortalScriptCDP
{
    ...
    private function initPortal($count)
    {
        ...
        if ($this->checkLogin()) {
            ...
            if ($this->exts->exists('nav li a[href*="#/devices/"]')) {
                $this->exts->moveToElementAndClick('nav li a[href*="#/devices/"]');
                sleep(5);
            }
            $this->exts->waitTillPresent('button.MuiCardActionArea-root');
            if ($this->exts->exists('button.MuiCardActionArea-root')) {
                $this->exts->moveToElementAndClick('button.MuiCardActionArea-root');
            }
